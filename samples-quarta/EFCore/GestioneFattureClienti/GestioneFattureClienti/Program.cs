...
static void LetturaDb()
{
	...
	listaClienti.ForEach(Console.WriteLine);
	...
	clientiConSpesa5000Plus.ToList().ForEach(Console.WriteLine);
	...
	clientiConSpesa5000Plus2.ToList().ForEach(Console.WriteLine);
}
